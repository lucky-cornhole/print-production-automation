...
return Application::configure(basePath:dirname(__DIR__))->withRouting(web:__DIR__.'/../routes/web.php',api:__DIR__.'/../routes/api.php',commands:__DIR__.'/../routes/console.php',health:'/up')->withMiddleware(function(Middleware $m){$m->alias(['factory.key'=>\App\Http\Middleware\FactoryKey::class]);})->withExceptions(function(Exceptions $e){})->create();
